      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <BoxReveal>
              <h2 className="text-3xl font-bold mb-6">
                <TextRoll>Custom Rug</TextRoll> Services
              </h2>
            </BoxReveal>
            <p className="text-muted-foreground mb-8">
              Our custom rug services allow you to create the perfect rug for your space, with complete control over design, size, materials, and more.
            </p>
          ...
          <div ref={imageRef} className="relative h-[400px] rounded-lg overflow-hidden">
            <Image
              src="/features/young-man-holding-camera-while-standing-against-wall_1048944-16315124.jpg"
