...
export function RepairHeroSection() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <BoxReveal>
              <h1 ref={headingRef} className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
                ...
                <TextRoll>Expert Rug Repair</TextRoll>{" "}
                <span className="block mt-2">& Restoration</span>
              </h1>
            </BoxReveal>
          ...
          <div ref={imageRef} className="relative h-[400px] rounded-lg overflow-hidden">
            <Image
              ...
              alt="Rug repair expert working on a Persian carpet"
              fill
