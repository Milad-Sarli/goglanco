...
export default function HeroAdmin() {
  ...
  const handleImageUpload = async (event: React.ChangeEvent<HTMLInputElement>, isMainImage: boolean = false) => {
    ...
    setUploading(true);
    try {
      const result = await heroService.uploadImage(file);
      
      if (isMainImage) {
        handleMainImageChange(result.url);
      } else {
        setHeroData({
          ...heroData,
          backgroundImages: [...heroData.backgroundImages, result.url],
        });
      }
          ...
          <div className="mb-6 flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Manage your website's hero section content and visuals
              </p>
            </div>
                  ...
                  <CardContent>
                    <div className="mb-4 space-y-4">
                      <div className="flex flex-col space-y-2">
                        <Label htmlFor="main-image-upload">Upload Image</Label>
                      ...
                      <div className="flex flex-col space-y-2">
                        <Label htmlFor="main-image">Or Enter Image URL</Label>
                        <Input
                          id="main-image"
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        {heroData.backgroundImages.map((imgUrl: string, index: number) => (
                          <motion.div 
                            key={index} 
